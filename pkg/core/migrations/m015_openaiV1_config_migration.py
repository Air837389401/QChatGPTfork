...
@migration.migration_class("openai-configV1-migration", 2)
class OpenAIConfigMigration(migration.Migration):
    ...
    async def run(self):
        ...
        if 'openai-chat_gptapiV1-completions' not in self.ap.provider_cfg.data['requester']:
            self.ap.provider_cfg.data['requester']['openai-chat_gptapiV1-completions'] = {}
