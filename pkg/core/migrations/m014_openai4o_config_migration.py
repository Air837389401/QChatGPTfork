...
@migration.migration_class("openai-config4o-migration", 2)
class OpenAIConfigMigration(migration.Migration):
    ...
    async def run(self):
        ...
        if 'openai-chat_gptapi4o-completions' not in self.ap.provider_cfg.data['requester']:
            self.ap.provider_cfg.data['requester']['openai-chat_gptapi4o-completions'] = {}
